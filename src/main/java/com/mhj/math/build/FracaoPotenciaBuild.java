...
@Slf4j
public class FracaoPotenciaBuild extends FracaoBuild {
	...
	public FracaoPotenciaBuild() {
		super();
	}

	@Override
	protected void titulo() {
		operacao.getRetorno().add(new Descricao(messageSource.getMessage("FracaoPotenciaBuild.titulo.1", null, locale)));
