...
<spring:message code="potencia.soma.del.operacao" var="potenciaDelOperacao"/>
				...
				<div id="expressoes" class="form-group">
					...
					<div class="form-group row">
						...
						<div style="padding-left: 5px">
							<input name="bases" type="number" min="1" max="999999" class="form-control input-xs" value="1"/> 							
							<label>&#x97;&#x97;&#x97;&#x97;</label>
	...
	<script type="text/javascript">
		...
		function addFracao() {
			var potencia = document.createElement("div");
			var numerador = document.createElement("input");
			numerador.setAttribute("name", "bases");
			...
			denominador.setAttribute("name", "expoentes");
			...
			potencia.appendChild(numerador);
			potencia.appendChild(divisor);
			potencia.appendChild(denominador);
			return potencia;
		}
